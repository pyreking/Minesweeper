...
public class MinesweeperApplet extends JApplet implements ActionListener, MouseListener {
	...
	public void loadImages() {
		try {
			bomb = new ImageIcon(MinesweeperApplet.class.getResource("res/bomb.gif"));
			clock = new ImageIcon(MinesweeperApplet.class.getResource("res/clock.png"));
			flag = new ImageIcon(MinesweeperApplet.class.getResource("res/flag.png"));
			skull = new ImageIcon(MinesweeperApplet.class.getResource("res/skull.gif"));
			wrongFlag = new ImageIcon(MinesweeperApplet.class.getResource("res/wrong_flag.png"));
		} catch(Exception e) {
			e.printStackTrace();
		}
	}
